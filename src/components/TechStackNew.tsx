...
const techStack: TechItem[][] = [
  ...
  [
    ...
    { name: "HTML5", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg", url: "https://developer.mozilla.org/docs/Web/HTML" },
    { name: "CSS3", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original.svg", url: "https://developer.mozilla.org/docs/Web/CSS" },
  ],
  [
    { name: "Linux", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linux/linux-original.svg", url: "https://www.debian.org" },
    { name: "Git", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg", url: "https://git-scm.com" },
    { name: "GitHub", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg", url: "https://github.com" },
    { name: "FFmpeg", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/ffmpeg/ffmpeg-original.svg", url: "https://ffmpeg.org" },
  ],
  [
  ...
  [
    { name: "Ollama", icon: "/images/placeholder.webp", url: "https://ollama.com" },
    { name: "ComfyUI", icon: "/images/placeholder.webp", url: "https://github.com/comfyanonymous/ComfyUI" },
  ],
];
